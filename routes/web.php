...
Route::group(['middleware' => 'Revalidate'],function() {
    Route::group(['middleware' => 'Authenticate'], function () {
        ...
        Route::post('/getunit', ['as' => 'sales.getunit', 'uses' => 'backend\SalesController@getunit']);
        ...
        Route::get('/customer-create', ['as' => 'Customers.customers.create', 'uses' => 'backend\CustomerController@create']);
         Route::post('/customer-store', ['as' => 'Customers.customers.store', 'uses' => 'backend\CustomerController@store']);
         Route::get('/customer-show/{id}', ['as' => 'Customers.customers.show', 'uses' => 'backend\CustomerController@show']);
         Route::get('/customer-edit/{id}', ['as' => 'Customers.customers.edit', 'uses' => 'backend\CustomerController@edit']);
         ...
         Route::get('/advsalary-create', ['as' => 'Advsalary.advsalary.create', 'uses' => 'backend\AdvancedSalaryController@create']);
