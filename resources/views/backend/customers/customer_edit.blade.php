                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form method="POST" action="{{ route('Customers.customers.edit', $contact->id) }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="state" class="col-md-12 col-form-label">@lang('state')</label>
                                ...
                                <div class="row form-group align-items-center">
                                    <div class="col-md-12 text-right">
                                        <button type="submit" class="btn btn-success">@lang('update-customer')</button>
                                    </div>
                                </div>
                            </form>
                </div>
