                    ...
                    <div class="x_content">
                        <form id="btnSave" action="{{route('sales.store')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="unit" name="unit" placeholder="Units" required>
                                <span class="error"><b>
                                         @if($errors->has('unit'))
                                            {{$errors->first('unit')}}
                                         @endif</b></span>
                            ...
                            <div class="form-group">
                                <label for="price">GST / Tax Rate*</label>
                                <input type="number" class="form-control" name="taxrate" id="taxrate" placeholder="taxrate" required>
                                <span class="error"><b>
